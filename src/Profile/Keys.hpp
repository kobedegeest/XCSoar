...
constexpr std::string_view TopographySelectedLayer = "TopographySelectedLayer";
...
constexpr std::string_view XCThermOpacity = "XCThermOpacity";
constexpr std::string_view XCThermSelectedLayers = "XCThermSelectedLayers";
constexpr std::string_view RainbowApiKey = "RainbowApiKey";
